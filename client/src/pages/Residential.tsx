        ...
        <article className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Link to="/residential/single-storey/3-bed" className="group block rounded-lg border bg-card/50 backdrop-blur-sm p-6 hover-scale" data-testid="link-single-storey-3bed">
              ...
              <Link to="/residential/single-storey/4-bed" className="group block rounded-lg border bg-card/50 backdrop-blur-sm p-6 hover-scale" data-testid="link-single-storey-4bed">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Link to="/residential/single-storey-duplex/3-bed" className="group block rounded-lg border bg-card/50 backdrop-blur-sm p-6 hover-scale" data-testid="link-duplex-3bed">
              ...
              <Link to="/residential/single-storey-duplex/4-bed" className="group block rounded-lg border bg-card/50 backdrop-blur-sm p-6 hover-scale" data-testid="link-duplex-4bed">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Link to="/residential/double-storey-duplex/3-bed" className="group block rounded-lg border bg-card/50 backdrop-blur-sm p-6 hover-scale" data-testid="link-double-duplex-3bed">
              ...
              <Link to="/residential/double-storey-duplex/4-bed" className="group block rounded-lg border bg-card/50 backdrop-blur-sm p-6 hover-scale" data-testid="link-double-duplex-4bed">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <Link to="/residential/apartment-blocks/ground-floor-studio" className="group block rounded-lg border bg-card/50 backdrop-blur-sm p-6 hover-scale" data-testid="link-studio">
              ...
              <Link to="/residential/apartment-blocks/first-floor-1bed" className="group block rounded-lg border bg-card/50 backdrop-blur-sm p-6 hover-scale" data-testid="link-1bed">
              ...
              <Link to="/residential/apartment-blocks/second-floor-2bed" className="group block rounded-lg border bg-card/50 backdrop-blur-sm p-6 hover-scale" data-testid="link-2bed">
